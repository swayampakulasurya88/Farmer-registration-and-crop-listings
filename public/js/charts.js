...
//
// Also re-renders when the realtime sync swaps the page content
// (event 'krishisetu:synced'), so charts stay live without a refresh.
...
(function () {
  ...
  // Re-render after a realtime sync swaps the page content in place.
  document.addEventListener('krishisetu:synced', render);
})();