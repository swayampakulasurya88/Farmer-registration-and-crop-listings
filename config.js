...
module.exports = {
  ...
  // Email (SMTP) settings for the forgot-password OTP email.
  // Leave host empty to run in DEMO MODE (OTP shown on screen + console).
  SMTP: {
    ...
    from: process.env.MAIL_FROM || 'KrishiSetu <no-reply@krishisetu.local>',
  },
